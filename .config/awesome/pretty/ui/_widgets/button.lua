...
function _button.normal(args)
    ...
    local update_callback = (type(args.update_callback) == "function") and args.update_callback or helpers.misc.pass
    ...
    content:connect_signal("mouse::leave", function (_, ...)
        ...
        -- Call the update callback
        update_callback(ret, content, args, "mouse::leave", ...)
    end)
    content:connect_signal("button::press", function (_, ...)
        update_callback(ret, content, args, "button::press", ...)
    end)
    content:connect_signal("button::release", function (_, ...)
        update_callback(ret, content, args, "button::release", ...)
    end)

    -- Call the create callback
    if type(args.create_callback) == "function" then args.create_callback(ret, content, args) end
